              ...
              containers = [
                {
                  ...
                  args = [
                    ...
                    "internal://redpanda.${namespace}.svc.cluster.local:9092"
                    "--rpc-addr"
                    "0.0.0.0:33145"
                    "--advertise-rpc-addr"
                    "redpanda.${namespace}.svc.cluster.local:33145"
                    "--smp"
                    "1"
                    "--memory"
                    "1G"
              ...
              containers = [
                {
                  ...
                  volumeMounts = [
                    {
                      name = "config";
                      mountPath = "/etc/clickhouse-server/config.d/e2e.xml";
                      subPath = "e2e.xml";
                    }
                    {
                      name = "data";
